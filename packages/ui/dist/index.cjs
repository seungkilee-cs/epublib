...
var ThemeContext = (0, import_react.createContext)(baseTheme);
function ThemeProvider({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeContext.Provider, { value: mergedTheme, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: classes, style: combinedStyle, children }) });
}
function useTheme() {
...
function NavigationControls({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: rootClassName, role: "group", "aria-label": "Reader navigation", children: [
...
function ReaderView({
  ...
  const handlePrev = (0, import_react2.useCallback)(async () => {
    if (!isReady || isNavigating) {
      return;
    }
    setIsNavigating(true);
  ...
  const statusText = (0, import_react2.useMemo)(() => {
    const status = {
  ...
  const atDocumentStart = (0, import_react2.useMemo)(() => {
    if (!currentLocation) {
      return true;
    }
    if (currentLocation.totalPages > 0 && currentLocation.page > 0) {
  ...
  const atDocumentEnd = (0, import_react2.useMemo)(() => {
    if (!currentLocation) {
      return true;
    }
    if (currentLocation.totalPages > 0 && currentLocation.page > 0) {
  ...
  const onTouchMove = (0, import_react2.useCallback)(
    (event) => {
      if (!enableTouchGestures || !isReady) {
        return;
      }
  ...
  const onTouchEnd = (0, import_react2.useCallback)(
    () => {
      if (!enableTouchGestures || !isReady) {
        return;
      }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { ref: containerRef, className: ReaderView_default.canvas }),
        ...
        statusText ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: ReaderView_default.statusBadge, role: "status", "aria-live": "polite", children: statusText }) : null
      ]
    }
  );
}
