import { IStorageAdapter, StorageInitializationOptions, Book, Annotation, AnnotationType, ReadingProgress, Collection, Settings, ReadingSession, IFileAdapter, FileOpenOptions, FileData, FileSaveOptions } from '@epub-reader/core';

declare class SQLiteStorageAdapter implements IStorageAdapter {
    initialize(_options?: StorageInitializationOptions): Promise<void>;
...
declare class TauriFileAdapter implements IFileAdapter {
...
export { SQLiteStorageAdapter, TauriFileAdapter };
